...
export interface Mutation {
  ...
  UpdateRideStatus: UpdateRideStatusReponse;
...
export interface UpdateRideStatusReponse {
  ok: boolean;
  error: string | null;
}
